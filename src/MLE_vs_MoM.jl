# Required imports - Minimal set for MoM and Newton methods only
...
# using Optim  # DEACTIVATED - not needed for MoM and Newton
# using NLopt  # DEACTIVATED - not needed for MoM and Newton
# using ForwardDiff  # DEACTIVATED - not needed for MoM and Newton
...
# DEACTIVATED: Compare all methods
...
# Print comparison results - DEACTIVATED
...
################
# ACTIVE: Modified MoM estimation with bounds and scaling
...
# DEACTIVATED: Modified negative log-likelihood function with bounds checking
...
# DEACTIVATED: Modified BFGS estimation
...
# DEACTIVATED: Modified Nelder-Mead estimation
...
# DEACTIVATED: Modified BOBYQA estimation
...
# ACTIVE: Modified Newton-Raphson estimation
...
# DEACTIVATED: Enhanced Newton-Raphson estimation
...
# DEACTIVATED: Hybrid optimization method with q parameter
...
# DEACTIVATED: Generate example data and run comparison
