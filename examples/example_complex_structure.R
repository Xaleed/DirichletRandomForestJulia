...
all_results <- run_multiple_simulations(
  ...
  n_iterations = 5,
  base_dir = "C:\\Users\\29827094\\Documents\\GitHub\\DirichletRandomForestJulia\\examples\\simulation_complex_results\\"
)
...
all_results <- run_multiple_simulations(
  sample_sizes = sample_sizes,
  n_iterations = 5,
  base_dir = "C:\\Users\\29827094\\Documents\\GitHub\\DirichletRandomForestJulia\\examples\\Results_simple_structure\\"
)
